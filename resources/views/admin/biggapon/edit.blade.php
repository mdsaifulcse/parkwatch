...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                {!! Form::open(['route' => ['biggapons.update',$biggapon->id], 'method'=>'PUT','class' => 'form-validation frmValidation', 'files' => true]) !!}

                    <label for="name">Ad Placement *</label>
                    <div class="form-group">
                        <div class="form-line  {{ $errors->has('place') ? 'error focused' : '' }}">

                            {{ Form::select('place',$places,$biggapon->place, ['placeholder'=>'Select One','class'=>'form-control','required'=>true]) }}
                    ...
                    <div class="form-group">
                        <div class="form-line  {{ $errors->has('photo') ? 'error focused' : '' }}">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <img src='{{ asset($biggapon->image?$biggapon->image:"public/assets/images/icons/user.png") }}' width="150" height="100" class="img-thumbnail">
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="switch {{ $errors->has('status') ? 'error focused' : '' }}">
                                    <label>
                                        OFF<input name="status" type="checkbox" {{ ($biggapon->status==\App\Models\Biggapon::ACTIVE?'checked':null) }}>
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    <div class="form-line  {{ $errors->has('serial_num') ? 'error focused' : '' }}">
                                        <input name="serial_num" type="text" class="form-control" value="{{$biggapon->serial_num}}" readonly>
                                    </div>
