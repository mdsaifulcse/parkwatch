    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    {{ $title }}
                    <a href="{{ url('admin/message/sent') }}" title="Sent Message" class="pull-right btn btn-xs btn-primary waves-effect"><i class="material-icons">list</i></a>
                </h2>
            </div>

            <div class="body">
                {!! Form::open(['url' => '/admin/message/new', 'class' => 'form-validation frmValidation', 'files' => true]) !!}
