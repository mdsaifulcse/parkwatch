...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card"> 
            ...
            <div class="body">
                {!! Form::open(['route' => ['faqs.update',$faq->id], 'method'=>'POST', 'class' => 'form-validation frmValidation', 'files' => true]) !!}
                ...
                <div class="form-group">
                    <div class="form-line  {{ $errors->has('question') ? 'error focused' : '' }}">
                        <input name="question" type="text" id="question" class="form-control" required placeholder="Enter Title Here" value="{{ old('question',$faq->question) }}">
                    </div>
                ...
                <div class="form-group">
                    <div class="form-line  {{ $errors->has('answer') ? 'error focused' : '' }}">
                        <textarea name="answer" type="text" id="answer" required  class="form-control" placeholder="Description"><?php echo $faq->answer;?></textarea>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="switch {{ $errors->has('status') ? 'error focused' : '' }}">
                            <label>
                                OFF<input name="status" type="checkbox" {{ ($faq->status==\App\Models\Faq::PUBLISHED?'checked':null) }}>
