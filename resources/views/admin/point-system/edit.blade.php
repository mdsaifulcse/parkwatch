...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card"> 
            ...
            <div class="body">
                {!! Form::open(['route' => ['point-system.update',$pointSystem->id], 'method'=>'PUT','class' => 'form-validation frmValidation', 'files' => true]) !!}
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="form-line  {{ $errors->has('min_point') ? 'error focused' : '' }}">
                                <input name="min_point" type="number" min="0" max="999999999"  id="min_point" class="form-control" placeholder="Minimum Point" value="{{ old('min_point',$pointSystem->min_point) }}">
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="form-line  {{ $errors->has('max_point') ? 'error focused' : '' }}">
                                <input name="max_point" type="number" min="0" max="999999999" id="max_point" class="form-control" placeholder="Maximum Point" value="{{ old('max_point',$pointSystem->max_point) }}">
                            </div>
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="form-group">
                            <div class="form-line  {{ $errors->has('badge_name') ? 'error focused' : '' }}">
                                <input name="badge_name" type="text" id="badge_name" class="form-control" placeholder="Badge Name Here" value="{{ old('badge_name',$pointSystem->badge_name) }}">
                            </div>
                        ...
                        <div class="form-group">
                            <label class="slide_upload" for="file">
                                ...
                                @if(file_exists($pointSystem->badge_icon))
                                    ...
                                    <img id="image_load" src=" {{asset($pointSystem->badge_icon)}}" style="width: 130px;
                                height: 130px;cursor: pointer;">
                                @else
                                    <img id="image_load" name="badge_icon" src="{{asset('images/default.png')}}" style="width: 130px;
                            height: 130px;cursor: pointer;">
                                @endif
                            </label>
                    ...
                    <div class="col-sm-3">
                        <label for="status">{{ Lang::label('Status') }} {{$pointSystem->status}}</label>
                        <div class="switch {{ $errors->has('status') ? 'error focused' : '' }}">
                            <label>
                                OFF<input name="status" type="checkbox" {{ ($pointSystem->status==\App\Models\PointSystem::ACTIVE?'checked':null) }}>
