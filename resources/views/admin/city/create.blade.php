...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                {!! Form::open(['route' => 'cities.store', 'method'=>'POST', 'class' => 'form-validation frmValidation', 'files' => true]) !!}
                ...
                <div class="form-group">
                    <div class="form-line  {{ $errors->has('city_name') ? 'error focused' : '' }}">
                        <input name="city_name" type="text" id="city_name" class="form-control" required placeholder="{{ Lang::label(' Enter City Name Here') }}" value="{{ old('city_name') }}">
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="switch {{ $errors->has('status') ? 'error focused' : '' }}">
                                    <label>
                                        OFF<input name="status" type="checkbox" checked="" value="{{\App\Models\City::PUBLISHED}}">
