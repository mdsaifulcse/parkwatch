...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                {!! Form::open(['route' => 'parking-rules.store', 'method'=>'POST', 'class' => 'form-validation frmValidation', 'files' => true]) !!}

                    <label for="name">{{ Lang::label('Name') }} *</label>
                    <div class="form-group">
                        <div class="form-line  {{ $errors->has('name') ? 'error focused' : '' }}">
                            <input name="name" type="text" id="name" class="form-control" required placeholder="{{ Lang::label(' Enter Rule Name Here') }}" value="{{ old('name') }}">
                        </div>
                        @if ($errors->has('name'))
                ...
                <div class="form-group">
                    <div class="form-line  {{ $errors->has('description') ? 'error focused' : '' }}">
                        <textarea name="description" type="text" id="description" class="form-control" placeholder="{{ Lang::label('Address') }}">{{old('description')}}</textarea>
                    </div>
                ...
                <div class="form-group">
                    <div class="form-line  {{ $errors->has('vehicle_restriction') ? 'error focused' : '' }}">
                        <textarea name="vehicle_restriction" type="text" id="vehicle_restriction" class="form-control" placeholder="{{ Lang::label('Vehicle Restriction') }}">{{old('vehicle_restriction')}}</textarea>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <div class="form-line  {{ $errors->has('available_date_time') ? 'error focused' : '' }}">
                                <input name="available_date_time" type="text" id="available_date_time" class="form-control datepicker" placeholder="{{ Lang::label('Date') }} " value="{{ old('available_date_time') }}" autocomplete="off">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="switch {{ $errors->has('is_legal') ? 'error focused' : '' }}">
                                        <label>
                                            OFF<input name="is_legal" type="checkbox" checked="" value="{{\App\Models\ParkingRule::YES}}">
