        ...
        <div class="card">
            <div class="header">
                ...
                <ul class="header-dropdown m-r--5">  
                    <li>
                        <a href="{{ url('website/profile') }}" title="Profile" class="btn btn-sm btn-primary waves-effect">
            ...
            <div class="body">
                {!! Form::open(['url' => 'website/profile/edit']) !!}
                        ...
                        <table class="dataTable table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($v->status==1)
                                        <a  onClick="return confirm('Are you sure?')" href="{{ url("website/vehicle/status/$v->status/$v->id") }}" title="{{ Lang::label("Disabled") }}" class="btn btn-xs btn-danger waves-effect"><i class="material-icons">close</i></a>
                                        @else 
                                        <a  onClick="return confirm('Are you sure?')" href="{{ url("website/vehicle/status/$v->status/$v->id") }}" title="{{ Lang::label("Enabled") }}" class="btn btn-xs btn-success waves-effect"><i class="material-icons">check</i></a>
                                        @endif 
                                    </td>
                                </tr>
                                @endforeach
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        {!! Form::open(['url' => 'website/vehicle', 'files' => true, 'id'=>'newVehicleFrm']) !!}
