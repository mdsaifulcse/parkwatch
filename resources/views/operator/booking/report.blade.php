        ...
        <div class="card"> 
            <div class="header">
                ...
                <ul class="header-dropdown m-r--5">  
                    ...
                    <li>
                        <a href="{{ url('operator/booking/form') }}" class="btn btn-sm btn-success waves-effect">
            ...
            <div class="body"> 
                <div class="table-responsivex">
                    {!! Form::open(['url' => 'operator/report', 'method'=>'get', 'class' => 'form-validation']) !!} 
                    <div class="row">
                        ...
                        <tbody>
                            @if(!empty($bookings))
                                ...
                                <tr>
                                    <td>{{ $loop->index+1 }}</td>
                                    <td>{{ $booking->id_no }}</td>
                                    <td><a href="{{ url('operator/parking_zone/'.$booking->place_id) }}" target="_blank">{{ $booking->place_name }}</a></td>
                                    <td>{{ $booking->space }}</td>
                                    <td><a href="{{ url('operator/client/profile/'.$booking->client_id_no) }}" target="_blank">{{ $booking->client_id_no }}</a></td>
